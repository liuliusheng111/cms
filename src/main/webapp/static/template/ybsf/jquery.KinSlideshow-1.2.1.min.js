	...
	$.fn.KinSlideshow = function(settings) {
		settings = jQuery.extend({
			...
			btn: {
				...
				btn_fontHoverColor: "#CC0000",
				btn_fontFamily: "Verdana",
				btn_borderColor: "#FFFFFF",
				btn_borderHoverColor: "#CC0000",
				btn_borderWidth: 1,
				btn_bgAlpha: 1
			}
		}, settings);
		...
		function KSS_setTitleFont() {
			if (settings.isHasTitleFont) {
				$(ksthis).append("<div class='KSS_titleBox'><h2 class='title' style='margin:10px 0 0 20px;padding:0;'></h2></div>");
		...
		function KSS_setBtn() {
			...
			if (settings.isHasBtn && KSS_imgaeLength >= 2) {
				$(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:20px;bottom:9px; z-index:100'></div>");
				var KSS_btnList = "";
				...
				$(ksbs + " #btnlistID li:eq(0)").css({
					...
					width: settings.btn.btn_hoverWidth,
					height: settings.btn.btn_hoverHeight
				});
			};
		};
